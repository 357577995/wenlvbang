<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\project\szy\wenlvbang\public/../application/index\view\research\zhikan_list.html";i:1532260291;s:63:"D:\project\szy\wenlvbang\application\index\view\common\top.html";i:1534054253;s:64:"D:\project\szy\wenlvbang\application\index\view\common\foot.html";i:1532316441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="main_c">
	<div class="main" id="content">
		...
		<!-- 内容部分 -->
		<div class="content wlyj">
			<ul class="newslist">
				<!-- <?php foreach($message as $message): ?> -->
				<li>
					<div>
						<a title="" href="javascript:void(0);">
							<img src="/image/<?php echo $message['image']; ?>" alt="" height="195" width="135">
						</a>
					</div>
					<div>
						<a title="" href="javascript:void(0);"><?php echo $message['title']; ?></a>
						<!-- <p><?php echo $message['content']; ?></p> -->
					</div>
					<div>
						<p>
							 
							<a href="/image<?php echo $message['onlinepdf']; ?>">在线阅读</a>
