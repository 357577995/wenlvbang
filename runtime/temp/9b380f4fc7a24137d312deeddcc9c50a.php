<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\project\szy\wenlvbang\public/../application/admin\view\seo\seo.html";i:1534141136;s:57:"D:\project\szy\wenlvbang\application\admin\view\base.html";i:1534141002;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="page-container">
				<form action="/admin/seo/seoinsert" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<?php echo $model['title']; ?>" id="title" name="title">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<?php echo $model['keywords']; ?>" id="keywords" name="keywords">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<?php echo $model['description']; ?>" id="description" name="description">
						</div>
					</div>
						<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
						<input type="hidden" class="input-text" value="1" id="is_list" name="is_list">
						<input type="hidden" class="input-text" value="<?php echo $type; ?>" id="type" name="type">
