<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\project\szy\wenlvbang\public/../application/index\view\search\index.html";i:1534057425;s:63:"D:\project\szy\wenlvbang\application\index\view\common\top.html";i:1534054253;s:64:"D:\project\szy\wenlvbang\application\index\view\common\foot.html";i:1532316441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="index_pro ytss">
	...
	<div class="fenlei">
		<a href="">业态分类：</a>
		<!-- <?php foreach($f_cate as $f_cate): ?> -->
		<a href="<?php echo $f_cate['url']; ?>" <?php if($f_cate['selected']): ?>class="sel"<?php endif; ?>><?php echo $f_cate['name']; ?></a>
		<!-- <?php endforeach; ?> -->
	</div>
	<div class="fenlei flz">
		<a href="">子分类：</a>
		<!-- <?php foreach($s_cate as $s_cate): ?> -->
		<a href="<?php echo $s_cate['url']; ?>" <?php if($s_cate['selected']): ?>class="sel"<?php endif; ?>><?php echo $s_cate['name']; ?></a>
		<!-- <?php endforeach; ?> -->
	</div>
	<div class="pro_list">
		<ul class="newslist">
			...
			<li>
				<div class="pro_pic">
					<a href="" title="">
						<img src="/image/<?php echo $plan['image']; ?>" alt="">
					</a>
				</div>
				<div class="pro_c">
					<a href="" title="">
				...
				<div class="pro_ico">
					...
					<span>
						<a href="/index/cart/add?plan_id=<?php echo $plan['id']; ?>">
		...
		<div class="paging" data-limit="<?php echo $limit; ?>">
			<input type="hidden" value="<?php echo $kws; ?>" id='kws' />
			<input type="hidden" value="<?php echo $f_id; ?>" id='f_id' />
			<input type="hidden" value="<?php echo $s_id; ?>" id='s_id' />
