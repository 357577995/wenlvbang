<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\project\szy\wenlvbang\public/../application/index\view\meeting\info.html";i:1535336461;s:63:"D:\project\szy\wenlvbang\application\index\view\common\top.html";i:1534054253;s:65:"D:\project\szy\wenlvbang\application\index\view\common\right.html";i:1532267974;s:64:"D:\project\szy\wenlvbang\application\index\view\common\foot.html";i:1532316441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="sp_content" id="contentLeft">
			<div class="content cpage">
				...
				<div>
					<!-- <?php if($last): ?> -->
					上一篇：
					<a href="/index/meeting/info.html?id=<?php echo $last['id']; ?>"><?php echo $last['title']; ?></a>
					<!-- <?php endif; ?> -->
					<!-- <?php if($next): ?> -->
					下一篇：
					<a href="/index/meeting/info.html?id=<?php echo $next['id']; ?>"><?php echo $next['title']; ?></a>
					<!-- <?php endif; ?> -->
					<br />
					<br />
				...
				<div>
					相关推荐：
					<br />
					根据添加文章是添加的标签来匹配相关推荐3个，如此文章的标签有“小程序”，则相关推荐的文章标签肯定也有“小程序“ <?php foreach($recomme as $recomm): ?>
					<a href="/index/meeting/info.html?id=<?php echo $recomm['id']; ?>"><?php echo $recomm['title']; ?></a>
					<br />
					<?php endforeach; ?>
