<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\project\szy\wenlvbang\public/../application/mobile\view\activity\list.html";i:1534841208;s:64:"D:\project\szy\wenlvbang\application\mobile\view\common\top.html";i:1534477148;s:65:"D:\project\szy\wenlvbang\application\mobile\view\common\foot.html";i:1534839054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="detail_list_bg">
	<div class="detail_list">
		<ul class='newslist'>
			<!-- <?php foreach($m_activity as $vo): ?> -->
			<li>
				<a href='/mobile/activity/info.html?id=<?php echo $vo['id']; ?>' title=''>
					<img src="/image/<?php echo $vo['image']; ?>">
					<div>
						<span><?php echo $vo['status_message']; ?></span>
					</div>
