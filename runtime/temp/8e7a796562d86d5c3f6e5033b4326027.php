<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\project\szy\wenlvbang\public/../application/mobile\view\news\list.html";i:1534840547;s:64:"D:\project\szy\wenlvbang\application\mobile\view\common\top.html";i:1534477148;s:65:"D:\project\szy\wenlvbang\application\mobile\view\common\foot.html";i:1534839054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="detail_class">
	<ul>
		<!-- <?php foreach($m_new_cate as $vo): ?> -->
		<li <?php if($cate_id == $vo['id']): ?>class="sel"<?php endif; ?>>
			<a href="/mobile/news/index.html?cate_id=<?php echo $vo['id']; ?>" title="<?php echo $vo['name']; ?>"><?php echo $vo['name']; ?></a>
		</li>
		<!-- <?php endforeach; ?> -->
	</ul>
</div>
			...
			<div class="tempWrap" style="overflow: hidden; position: relative;">
				<ul style="">
					<li style="display: table-cell; vertical-align: top; width: 707px;">
						<a class="pic" href="/mobile/news/info.html?id=<?php echo $recommend1['id']; ?>">
							<img src="/image/<?php echo $recommend1['image']; ?>" width="100%">
							<div class="b"></div>
							<div class="t"><?php echo $recommend1['title']; ?></div>
						</a>
						</a>
					</li>
					<li style="display: table-cell; vertical-align: top; width: 707px;">
						<a class="pic" href="/mobile/news/info.html?id=<?php echo $recommend2['id']; ?>">
							<img src="/image/<?php echo $recommend2['image']; ?>" width="100%">
							<div class="b"></div>
							<div class="t"><?php echo $recommend2['title']; ?></div>
						</a>
						</a>
					</li>
				</ul>
...
<div class="detail_list_news">
	<ul class='newslist'>
		...
		<li>
			<a title="" href="/mobile/news/info.html?id=<?php echo $vo['id']; ?>">
				<div>
