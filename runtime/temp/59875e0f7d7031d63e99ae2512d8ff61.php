<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\project\szy\wenlvbang\public/../application/admin\view\activity\add.html";i:1534140404;s:57:"D:\project\szy\wenlvbang\application\admin\view\base.html";i:1534141002;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="page-container">
				<form action="/admin/activity/insert" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
					<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							...
							<span class='span_<?php echo $vo['id']; ?>' style="margin-left: 6px; height: 24px; border: 1px solid #e8e8e8; font-size: 12px; line-height: 24px; display: inline-block; margin: 2px; padding: 0 6px; position: relative; border-radius: 2px 2px 2px 2px;">
								<input class='check_<?php echo $vo['id']; ?>' type="checkbox" name="tab[]" value="<?php echo $vo['id']; ?>" />
								<?php echo $vo['name']; ?>
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<!-- <input size="16" type="text" value="" name='start_time' class="form_datetime"> -->
							<input type="text" onfocus="WdatePicker()" class="input-text Wdate" name="start_time" style="width: 120px;" value="<?php if(isset($new['time'])): ?><?php echo date('Y-m-d H:i:s',$new['time']); endif; ?>">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<!-- <input size="16" type="text" value="" name='end_time' class="form_datetime"> -->
							<input type="text" onfocus="WdatePicker()" class="input-text Wdate" name="end_time" style="width: 120px;" value="<?php if(isset($new['time'])): ?><?php echo date('Y-m-d H:i:s',$new['time']); endif; ?>">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
