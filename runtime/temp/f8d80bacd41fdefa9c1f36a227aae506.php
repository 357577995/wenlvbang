<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\project\szy\wenlvbang\public/../application/admin\view\news\edit.html";i:1534140243;s:57:"D:\project\szy\wenlvbang\application\admin\view\base.html";i:1534141002;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="page-container">
				<form action="/admin/news/update" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<?php echo $new['title']; ?>" id="title" name="title">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<select name="cate_id" class="input-text" id="cate_id">
								...
								<option value="<?php echo $vo['id']; ?>" <?php if($new['cate_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<img src="/image<?php echo $new['image']; ?>" alt="" width="100">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<?php foreach($tab as $vo): ?>
							<span class='span_<?php echo $vo['id']; ?>' style="margin-left: 6px; height: 24px; border: 1px solid #e8e8e8; font-size: 12px; line-height: 24px; display: inline-block; margin: 2px; padding: 0 6px; position: relative; border-radius: 2px 2px 2px 2px;">
								<input type="checkbox" name="tab[]" value="<?php echo $vo['id']; ?>" <?php if(in_array($vo['id'],$tab_ids)): ?> checked<?php endif; ?> />
								<?php echo $vo['name']; ?>
								<B class='del_tab' data-id="<?php echo $vo['id']; ?>">&times;</B>
							</span>
							<?php endforeach; ?>
							<input type="text" class="input-text" value="" id="new_tab" name="new_tab">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<textarea rows="5" cols="100" id="abstract" name="abstract"><?php echo $new['abstract']; ?></textarea>
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<?php echo $new['author']; ?>" id="author" name="author">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<script id="editor" name="content" type="text/plain" style="width: 1000px; height: 500px;"><?php echo $new['content']; ?></script>
						</div>
						<label class="form-label col-xs-4 col-sm-2">
							<span class="c-red">*</span>
							未登录显示内容：
						...
						<div class="formControls col-xs-8 col-sm-9">
							<script id="offline_editor" name="offline_content" type="text/plain" style="width: 1000px; height: 500px;"><?php echo $new['offline_content']; ?></script>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-4 col-sm-2">
								SEO标题：
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" class="input-text" value="<?php echo $new['seo_title']; ?>" name="seo_title">
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-4 col-sm-2">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" class="input-text" value="<?php echo $new['seo_keywords']; ?>" name="seo_keywords">
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-4 col-sm-2">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" class="input-text" value="<?php echo $new['seo_description']; ?>" name="seo_description">
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-4 col-sm-2">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="radio" name="recommend" value="0" <?php if($new['recommend']==0): ?>checked<?php endif; ?>>
								不推荐
								<input type="radio" name="recommend" value="1" <?php if($new['recommend']==1): ?>checked<?php endif; ?>>
								推荐
							</div>
						</div>
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" name="sort" value="<?php echo $new['sort']; ?>" id='sort'>
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" onfocus="WdatePicker()" class="input-text Wdate" name="time" style="width: 200px;" value="<?php if(isset($new['time'])): ?><?php echo date('Y-m-d H:i:s',$new['time']); endif; ?>">
								<!-- <input size="16" type="text" value="<?php echo date("Y-m-d",$new['time']); ?>" name='time' class="form_datetime"> -->
							</div>
						</div>
					</div>
