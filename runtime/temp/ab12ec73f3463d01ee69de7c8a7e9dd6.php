<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\project\szy\wenlvbang\public/../application/index\view\meeting\meeting_list.html";i:1528895960;s:63:"D:\project\szy\wenlvbang\application\index\view\common\top.html";i:1534054253;s:64:"D:\project\szy\wenlvbang\application\index\view\common\foot.html";i:1532316441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="main" id="content">
		...
		<div class="pro_list wlhd">
			<ul class='result_list'>
				...
				<li>
					<div class="pro_pic">
						<a href="/index/meeting/info.html?id=<?php echo $message['id']; ?>" title="">
							<img src="/image/<?php echo $message['image']; ?>" alt="">
						</a>
						<span>2018.夏</span>
					</div>
					<div class="pro_c">
						<a href="/index/meeting/info.html?id=<?php echo $message['id']; ?>" title="">
							...
							<span <?php if($message['status']==2): ?>class='js'<?php endif; ?>><?php echo $message['status_message']; ?></span>
						</a>
						<div><?php echo $message['content']; ?></div>
					</div>
					<div class="pro_ico">
						<a href="/index/meeting/info.html?id=<?php echo $message['id']; ?>">更多&gt;&gt;</a>
					</div>
				</li>
				<!-- <?php endforeach; ?> -->
			</ul>
