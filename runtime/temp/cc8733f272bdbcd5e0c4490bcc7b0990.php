<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\project\szy\wenlvbang\public/../application/index\view\news\list.html";i:1530786646;s:63:"D:\project\szy\wenlvbang\application\index\view\common\top.html";i:1534054253;s:65:"D:\project\szy\wenlvbang\application\index\view\common\right.html";i:1536124233;s:64:"D:\project\szy\wenlvbang\application\index\view\common\foot.html";i:1532316441;}*/ ?>
 <!DOCTYPE html>
<html>
<head>
			...
			<div class="sp_banner">
				...
				<script type="text/javascript">
					var atmdateA = [{
						...
						"pic_path": "",
						"title": "banner",
						"href": "/index/news/info.html?id=<?php echo $recommend1['id']; ?>",
						"url": "/image/<?php echo $recommend1['image']; ?>"
					}, {
						"is_url": "0",
						"url_controller": "",
						"url_action": "",
						...
						"pic_path": "",
						"title": "banner",
						"href": "/index/news/info.html?id=<?php echo $recommend2['id']; ?>",
						"url": "/image/<?php echo $recommend2['image']; ?>"
					}];
				...
				<div class="itao">
					<ul>
						...
						<li>
							<a title="" href="/index/news/info.html?id=<?php echo $vo['id']; ?>">
								<img src="/image/<?php echo $vo['image']; ?>" />
								<span><?php echo $vo['name']; ?></span>
								<h2><?php echo $vo['abstract']; ?></h2>
							</a>
						</li>
						<!-- <?php endforeach; ?> -->
					</ul>
			...
			<div class="content">
				<ul class="newslist">
					...
					<li>
						<div>
							<a title="" href="/index/news/info.html?id=<?php echo $vo['id']; ?>">
								<img src="/image/<?php echo $vo['image']; ?>" alt="" height="160" width="225">
							</a>
						</div>
						<div>
							<a title="" href="/index/news/info.html?id=<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></a>
							 <p class="gaishu"><?php echo mb_substr($vo['abstract'],0,120,"utf-8"); ?>...</p> 
							<p class="shijian">
								<span style="float:left"> <?php echo $vo['name']; ?> </span><span>   <?php echo $vo['author']; ?>  <?php echo date("m-d",$vo['time']); ?></span>
							</p>
						</div>
					</li>
					<!-- <?php endforeach; ?> -->
			...
			<ul>
				<li>
					<a href="/index/dakashuo/info.html?id=<?php echo $dakazhuanfang['id']; ?>" title="">
						...
						<span><?php echo $dakazhuanfang['name']; ?>1</span>
