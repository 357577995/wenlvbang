<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\project\szy\wenlvbang\public/../application/admin\view\seo\index_seo.html";i:1534061139;s:57:"D:\project\szy\wenlvbang\application\admin\view\base.html";i:1534141002;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
			...
			<div class="page-container">
				<form action="/admin/seo/seoinsert" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
					...
					<div class="row cl">
						...
						<input type="hidden" class="input-text" value="7" id="type" name="type">
