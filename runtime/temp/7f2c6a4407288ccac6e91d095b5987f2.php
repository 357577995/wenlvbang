<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\project\szy\wenlvbang\public/../application/admin\view\research\edit.html";i:1536122329;s:57:"D:\project\szy\wenlvbang\application\admin\view\base.html";i:1534141002;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
		...
		资讯列表
		<span class="c-gray en">&gt;</span>
		修改资讯 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a> </nav>
<div class="Hui-article">
		<article class="cl pd-20">
			<div class="page-container">
			<form action="/admin/research/update" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
				<div class="row cl">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>PDF：</label>
					<div class="formControls col-xs-8 col-sm-9">
				...
				<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
						 ...
						 -->
						 <input type="text" onfocus="WdatePicker()" class="input-text Wdate" name="time" style="width:120px;" value="<?php if(isset($new['time'])): ?><?php echo date('Y-m-d H:i:s',$new['time']); endif; ?>"></div>
					</div>
