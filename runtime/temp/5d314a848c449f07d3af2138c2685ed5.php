<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\project\szy\wenlvbang\public/../application/admin\view\research\add.html";i:1530407053;s:57:"D:\project\szy\wenlvbang\application\admin\view\base.html";i:1534141002;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
		...
		资讯列表
		<span class="c-gray en">&gt;</span>
		添加资讯 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a> </nav>
<div class="Hui-article">
		<article class="cl pd-20">
			<div class="page-container">
			<form action="/admin/research/insert" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
				<div class="row cl">
