<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\project\szy\wenlvbang\public/../application/admin\view\news\add.html";i:1534140204;s:57:"D:\project\szy\wenlvbang\application\admin\view\base.html";i:1534139390;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="page-container">
				<form action="/admin/news/insert" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
					<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<textarea rows="5" cols="100" id="abstract" name="abstract"></textarea>
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" name="sort" value="" id='sort'>
						</div>
					</div>
					<div class="row cl">
						<div class="row cl">
