<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\project\szy\wenlvbang\public/../application/index\view\activity\activityinfo.html";i:1535336432;s:63:"D:\project\szy\wenlvbang\application\index\view\common\top.html";i:1534054253;s:65:"D:\project\szy\wenlvbang\application\index\view\common\right.html";i:1536209268;s:64:"D:\project\szy\wenlvbang\application\index\view\common\foot.html";i:1532316441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="main" id="content">
		...
		<div class="sp_content" id="contentLeft">
			<div class="content cpage">
				...
				<h1 class="c_tit"><?php echo $project['title']; ?></h1>
				<div class="c_data"><?php echo date("Y-m-d",$project['time']); ?></div>
				<div class="c_txt"><?php echo $project['content']; ?></div>
				
				<div>
					<!-- <?php if($last): ?> -->
					上一篇：
					<a href="/index/activity/info.html?id=<?php echo $last['id']; ?>"><?php echo $last['title']; ?></a>
					<!-- <?php endif; ?> -->
					<!-- <?php if($next): ?> -->
					下一篇：
					<a href="/index/activity/info.html?id=<?php echo $next['id']; ?>"><?php echo $next['title']; ?></a>
					<!-- <?php endif; ?> -->
					<br />
					<br />
				...
				<div>
					...
					<a href="/index/activity/info.html?id=<?php echo $recomm['id']; ?>"><?php echo $recomm['title']; ?></a>
					<br />
					<?php endforeach; ?>
...
<div class="sp_right" id="contentRight">
	...
	<div class="sub_common">
		<div class="sub_common_title">
			<h2>文旅培训</h2>
			<a href="/index/activity/index.html" title="更多">更多</a>
		</div>
		<div class="sub_youhui_content itao">
			<ul>
				<li>
					<a href="/index/activity/info.html?id=<?php echo $activityc['id']; ?>" title="">
						<img src="/image/<?php echo $activityc['image']; ?>" />
						<span><?php echo $activityc['name']; ?></span>
						<h2><?php echo $activityc['title']; ?></h2>
					</a>
				</li>
			</ul>
		</div>
		<div class="sub_youhui_content ilist">
			<ul>
				<!-- <?php foreach($activity_arcitle as $key=>$activity_arcitle): ?> -->
				<?php if($key < 2): ?>
				<li>
					<a href="/index/activity/info.html?id=<?php echo $activity_arcitle['id']; ?>" title="">
						<span>报名中</span>
						<h2><?php echo $activity_arcitle['title']; ?></h2>
					</a>
				</li>
				<?php endif; ?>
				<!-- <?php endforeach; ?> -->
		...
		<div class="sub_youhui_content itao">
			<ul>
			<!-- <?php foreach($nactivity_arcitle as $key=>$activity_arcitle): ?> -->
			<?php if($key == 3): ?>
				<li>
					<a href="/index/activity/info.html?id=<?php echo $activity_arcitle['id']; ?>" title="">
						<img src="/image/<?php echo $activity_arcitle['image']; ?>" />
						<h2><?php echo $activity_arcitle['title']; ?></h2>
					</a>
				</li>
			<?php endif; ?>
			...
			<ul>
				<li>
					<a href="/index/dakashuo/info.html?id=<?php echo $dakazhuanfang['id']; ?>" title="">
						...
						<span><?php echo $dakazhuanfang['name']; ?></span>
