<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\project\szy\wenlvbang\public/../application/admin\view\research\index.html";i:1528599626;s:57:"D:\project\szy\wenlvbang\application\admin\view\base.html";i:1534141002;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 新闻资讯 <span class="c-gray en">&gt;</span> 资讯列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article">
		<div>
			<div class="pd-20">
				<div class="mt-20">
					<form action="/admin/research/index" method="get" accept-charset="utf-8">
						<div class="text-c"> 
					...
					<table class="table table-border table-bordered table-bg table-hover table-sort">
						<thead>
							<tr class="text-c">
								...
								<th width="120">资讯类别</th>
								<th width="120">资讯图片</th>
								<th >资讯内容</th>
						...
						<?php foreach($research as $vo): ?>
							<tr class="text-c va-m">
								...
								<td class="td-manage">
									<a style="text-decoration:none"  class="btn btn-success radius" href="/admin/research/edit?id=<?php echo $vo['id']; ?>" >编辑</a>
									<a style="text-decoration:none" class="btn btn-primary radius" href="/admin/research/del?id=<?php echo $vo['id']; ?>" onclick="javascript:return confirm('确认删除吗？')" >删除</a>
								</td>
							</tr>
						<?php endforeach; ?>
						</tbody>
