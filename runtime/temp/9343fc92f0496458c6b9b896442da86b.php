<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\project\szy\wenlvbang\public/../application/index\view\expert\list.html";i:1532949207;s:63:"D:\project\szy\wenlvbang\application\index\view\common\top.html";i:1534054253;s:72:"D:\project\szy\wenlvbang\application\index\view\common\right_expert.html";i:1530371196;s:64:"D:\project\szy\wenlvbang\application\index\view\common\foot.html";i:1532316441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="main_c">
	<div class="main" id="content">
		...
		<div class="sp_content" id="contentLeft">
			<div class="content wlzk">
				<ul class="zjlist">
					<!-- <?php foreach($expert as $expert): ?> -->
					<li>
						<div>
							<a title="" href=" " style="display:block; width:140px; height:140px; background:url(/image<?php echo $expert['image']; ?>) no-repeat top center;      border-radius: 50%;
    overflow: hidden;">
								<!--<img src="/image<?php echo $expert['image']; ?>" alt="" height="160" width="225">-->
							</a>

						</div>
						<div>
							<a title="" href=" "><?php echo $expert['name']; ?></a>  
							 

							<span>擅长领域：<?php echo $expert['place']; ?></span>
							<p><?php echo $expert['content']; ?></p>
						</div>
						<!--<div>
							<p>
								<a href="/index/expert/info.html?id=<?php echo $expert['id']; ?>">详情</a>
							</p>
						</div>
						-->
					</li>
...
<div class="sp_right" id="contentRight">
	...
	<div class="sub_common">
		...
		<div class="sub_youhui_content ilist2" align="center">
			<form action="/index/expert/insert" method="post" onsubmit="return check(this)" class="zjsqrz">
				<div>
					<span>专家姓名</span>
				...
				<div>
					<span>个人简介</span>
					<textarea name="content" cols="" rows="" style="width: 160px; border-bottom: #CC9900 1px solid; height: 60px; background-color: #f8f8f8"></textarea>
					<br />
					<input name="" type="submit" value="立即申请" style="width: 80px; height: 28px; background-color: #f7921e; color: #FFFFFF;" />
				</div>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
	$(".paging").click(function() {
		...
		$.ajax({
			type: 'GET',
			url: '/index/expert/more',
			data: {
				limit: limit
			},
			success: function(result) {
				if (result.code == 1) {
					$(".zjlist").append(result.data);
				} else {
					$(".paging").hide();
				}
			},
