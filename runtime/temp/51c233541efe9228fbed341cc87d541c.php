	...
	<div class="main" id="content">
		...
		<div class="sp_content" id="contentLeft">
			<div class="content cpage">
				...
				<h1 class="c_tit"><?php echo $dakashuo['title']; ?></h1>
<div class="c_data">资讯分类：<?php echo $cate_info['name']; ?> &nbsp;&nbsp;&nbsp;&nbsp;   发布时间：<?php echo date("Y-m-d",$dakashuo['time']); ?> </div>			 
				<div class="c_txt"><?php echo $dakashuo['content']; ?></div>
			 <div>
					<!-- <?php if($last): ?> -->
					上一篇：
					<a href="/index/dakashuo/info.html?id=<?php echo $last['id']; ?>"><?php echo $last['title']; ?></a>
					<!-- <?php endif; ?> -->
					<!-- <?php if($next): ?> -->
					下一篇：
					<a href="/index/dakashuo/info.html?id=<?php echo $next['id']; ?>"><?php echo $next['title']; ?></a>
					<!-- <?php endif; ?> -->
					<br />
					<br />
