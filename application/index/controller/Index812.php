...
class Index extends Controller
{
	...
	public function index ()
	{
		...
		// 大咖
		$daka = DB::table('dakashuo')->limit(0, 3)->select();
		...
		if(isset($recommend['0']))
		{
			$this->assign('recommend', $recommend['0']);
		}
		if(isset($recommend['1']))
		{
			$this->assign('recommend1', $recommend['1']);
		}
		$seo = Db::table('seo')->where('type = 7 and is_list=0')->find();
